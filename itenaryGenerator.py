...
# Load your API key from an environment variable or secret management service
    ...
    prompt = "In an ecological manner doing outdoor activities, make me an activities guide within a reaosnable amount of time in the way of an itenary on my way from" + startLoc +  " to " + endLoc + "\n For example: \n Time = HH:MM \n decisions = a location someone might want to stop at AM/PM examples: \n time: decisions"
